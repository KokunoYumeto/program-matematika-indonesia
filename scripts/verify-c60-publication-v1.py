"""Resumable anonymous readback of one bounded C60 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/c60-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "c60-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified C60 adapter, integration, test, authority, "
...
SESSION.headers["User-Agent"] = "c60-capability-anonymous-readback/1.0"
