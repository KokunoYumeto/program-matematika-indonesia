"""Resumable anonymous readback of one bounded C120 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/c120-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "c120-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified C120 adapter, integration, test, and generated "
...
SESSION.headers["User-Agent"] = "c120-capability-anonymous-readback/1.0"
