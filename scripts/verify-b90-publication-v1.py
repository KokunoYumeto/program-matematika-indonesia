"""Resumable anonymous readback of one bounded B90 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/b90-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "b90-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified B90 adapter, integration, test, authority, "
            "and generated learner-site file at the exact commit; every changed "
...
SESSION.headers["User-Agent"] = "b90-capability-anonymous-readback/1.0"
