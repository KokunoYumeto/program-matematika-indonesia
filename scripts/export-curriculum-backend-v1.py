    ...
    def build(self) -> dict:
        ...
        self.rights_id = self.add(
            ...
            self.base(
                ...
                attribution="Floris — Program Matematika Indonesia",
                ...
                notice_locator=self.metadata_notice_path.as_posix(),
        ...
        self.hub_resource_id = self.add(
            ...
            self.base(
                ...
                creator_name="Floris and the local Codex production workflows",
