"""Resumable anonymous readback of one bounded A20 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/a20-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "a20-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified A20 adapter, integration, test, authority, "
...
SESSION.headers["User-Agent"] = "a20-capability-anonymous-readback/1.0"
