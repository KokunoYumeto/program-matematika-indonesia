#!/usr/bin/env python3
"""Reserve the v0.62.0 Zenodo version in the existing PMI concept.
...
def main() -> int:
    ...
    require(predecessor.get("metadata", {}).get("version") == "0.61.0", "predecessor version differs")
    ...
    receipt = {
        ...
        "next_action": (
            ...
            f"v0.61.0 draft inventory with the exact validated v{VERSION} inventory, preserve public-open metadata, "
