...
const contracts = {
  ...
  'c60.open_learner_hub':['C60','course_reader','backend/c60/C60.html'],
...
export function projectCapabilityTools(capsules, courseIds) {
  ...
  for (const capsule of capsules) for (const tool of capsule.layers.learner.tools ?? []) {
    ...
    // Explicit A20, B40, B80, B90, Lebl, Geometry, Topology, C60, C70, C110, C120, D10, D30, D40, D70, D80, D90, D100 and D120 presentation contracts; no generic auto-admission.
