"""Resumable anonymous readback of one bounded C110 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/c110-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "c110-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified C110 adapter, integration, test, and generated "
...
SESSION.headers["User-Agent"] = "c110-capability-anonymous-readback/1.0"
