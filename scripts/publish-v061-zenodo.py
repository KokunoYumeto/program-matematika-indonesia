#!/usr/bin/env python3
"""Publish PMI v0.61.0 to its reserved Zenodo version and verify all public surfaces."""
...
AUTHORITY_SOURCE_COMMIT = "48d180c7ad1ca3b1252bdbe5181e61a4caa90ae4"
RELEASE_COMMIT = "9cd256a78be612dd1227caed37ca227aba10104f"
...
LOGBOOK_RECEIPT = LOGBOOK / "132_CENTRAL_V061_PUBLICATION_RECEIPT_20260828.json"
...
TITLE = "Program Matematika Indonesia v0.61.0 — Mulai Belajar dan Peta Kurikulum Terbuka"
DESCRIPTION = (
    ...
    "<p>Rilis v0.61.0 memperbarui D60 Topologi Aljabar ke checkpoint publik v0.31.4: Roberts 30/30, Fomberg §§1.1–1.13, "
    "penguasaan wajib 108/108, dan laboratorium komputasi 2/4. D60 dan program keseluruhan belum lengkap; edisi yang masih "
    "diproduksi tetap ditandai secara eksplisit. Untuk mulai tanpa browser, buka "
    "<code>00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.61.0.pdf</code> atau "
    "<code>01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.61.0.html</code>.</p>"
...
NOTES = (
    "Snapshot terverifikasi v0.61.0 dengan checkpoint D60 v0.31.4. D60 dan program keseluruhan belum lengkap; status lengkap "
    "dan produksi berjalan ditampilkan secara eksplisit. Bahan tambahan dengan lisensi berbeda dipisahkan dari kursus utama."
)
...
def write_receipt(
    ...
    receipt = {
        "schema_id": "program-matematika-indonesia/combined-publication-receipt/v17",
        "version": VERSION,
