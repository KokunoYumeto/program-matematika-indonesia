"""Resumable anonymous readback of one bounded D100 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/d100-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "d100-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified D100 adapter, integration, test, and generated "
...
SESSION.headers["User-Agent"] = "d100-capability-anonymous-readback/1.0"
