"""Resumable anonymous readback of one bounded D120 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/d120-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "d120-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified D120 adapter, integration, test, and generated "
...
SESSION.headers["User-Agent"] = "d120-capability-anonymous-readback/1.0"
