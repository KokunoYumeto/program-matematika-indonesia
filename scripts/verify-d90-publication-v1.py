"""Resumable anonymous readback of one bounded D90 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/d90-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "d90-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified D90 adapter, integration, test, authority, "
...
SESSION.headers["User-Agent"] = "d90-capability-anonymous-readback/1.0"
