"""Resumable anonymous readback for one backend-coverage increment."""
...
PATHS = subprocess.check_output(
    [
        ...
        "backend/authority/course-capsule-hosted-page-identities-v1.json",
        "backend/course-capsule-v1/adapters/c60-capability-v1/publication/GITHUB_READBACK_306c9e080f89.json",
        ...
        "docs/interface/build-receipt.json",
    ],
    cwd=ROOT,
    text=True,
).splitlines()
...
TARGET = (
    ...
    / ("PROGRAM_BACKEND_COVERAGE_READBACK_" + ARGS.commit[:12] + ".json")
)
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "program-backend-coverage-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every source and generated coverage file changed by the bounded "
            "coverage increment, plus every changed docs file through GitHub Pages."
        ),
    }
)
...
SESSION.headers["User-Agent"] = "program-backend-coverage-anonymous-readback/1.0"
