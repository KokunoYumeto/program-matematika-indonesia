"""Resumable anonymous readback of one bounded D10 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/d10-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "d10-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified D10 adapter, integration, test, and generated "
...
SESSION.headers["User-Agent"] = "d10-capability-anonymous-readback/1.0"
