"""Resumable anonymous readback of one bounded B40 integration commit."""
...
TARGET = (
    ROOT
    / "backend/course-capsule-v1/adapters/b40-capability-v1/publication"
...
RECEIPT = (
    ...
    if TARGET.exists()
        ...
        "schema": "b40-integration-public-readback/1",
        "state": "in_progress",
        ...
        "failures": [],
        "scope": (
            "Every added or modified B40 adapter, integration, test, authority, "
            "and generated learner-site file at the exact commit, including the "
            "preserved C70 authority-source reproducibility repair; every changed "
            "docs file is also checked through GitHub Pages."
        ),
    }
)
...
SESSION.headers["User-Agent"] = "b40-capability-anonymous-readback/1.0"
