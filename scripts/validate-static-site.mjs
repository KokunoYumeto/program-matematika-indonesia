...
assert.equal(centralNavigation.summary.course_surface_roots, 26);
assert.equal(centralNavigation.summary.course_surface_html_documents, 67);
assert.equal(centralNavigation.summary.navigation_overlay_documents, 342);
assert.equal(centralNavigation.summary.classified_html_documents, 345);
assert.deepEqual(
