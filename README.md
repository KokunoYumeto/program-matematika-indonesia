...
- Snapshot v0.61.0 memperbarui D60 Topologi Aljabar ke checkpoint publik v0.31.4: Roberts 30/30, Fomberg §§1.1–1.13, penguasaan wajib 108/108, dan laboratorium komputasi 2/4, dengan pembaca HTML siswa langsung dan PDF preservasi. D60 tetap berstatus produksi; checkpoint yang belum lengkap tidak dihitung sebagai korpus selesai.
...
Snapshot v0.61.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22148050](https://doi.org/10.5281/zenodo.22148050), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.61.0 mempertahankan seluruh kapabilitas v0.60.0 dan memperbarui D60 ke pembaca siswa serta bukti publik terbarunya. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.61.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.61.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
