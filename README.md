...
- Lima belas peran mata kuliah sudah memiliki edisi lengkap yang dapat dibaca secara publik. Kelima belas peran itu memakai empat belas rekaman edisi berbeda karena C30 dan C40 berbagi satu edisi Judson. v0.49.0 mempertahankan jumlah itu dan memperbarui tautan kemajuan publik yang terverifikasi untuk keluarga Lebl U319, Analisis Fungsional Bab 12, dan checkpoint pendukung Statistika Matematis 16/29.
...
Snapshot v0.49.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22074079](https://doi.org/10.5281/zenodo.22074079), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. Tidak ada peran baru yang dinyatakan selesai pada v0.49.0. C20 tetap produksi meskipun pembaca U319 180 halaman dapat dibaca; B70 dan C50 kini menautkan unit publik U319 tanpa menyamarkannya sebagai pembaca lengkap; D20 menautkan pembaca Bab 1–12; dan C140 menautkan checkpoint pendukung Random 16/29. Setiap mata kuliah membawa `ownerLane` yang divalidasi terhadap peta semantik lengkap, sehingga permutasi pemilik tidak dapat lolos hanya karena jumlah ID tetap 40/40.
