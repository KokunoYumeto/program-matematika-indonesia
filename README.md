...
- Enam belas peran mata kuliah sudah memiliki edisi lengkap yang dapat dibaca secara publik. Enam belas peran itu memakai lima belas rekaman edisi berbeda karena C30 dan C40 berbagi satu edisi Judson. Tambahan terbaru adalah D20 Analisis Fungsional: edisi 298 halaman dengan 17 bab, solusi, dan jembatan spektral/SVD. Situs belajar tetap menjadi tujuan utama, sedangkan lembar mulai-belajar PDF menjadi pratinjau Zenodo sebelum arsip mesin.
...
- Federasi v2 adalah lapisan penghubung ringkas, bukan pengganti situs atau buku: 2.430 rekaman menghubungkan 34 dataset, 40 mata kuliah, 126 permukaan baca unik, 41 rute publik, bukti publikasi, dan 2.122 identitas v1. Satu URL pembaca direpresentasikan satu kali dengan beberapa aksi (`learn`, `html`, atau `offline`) agar antarmuka pelajar dan mesin tidak menduplikasi permukaan yang sama. Seluruh sumber korpus dan backend native pemilik tetap menjadi otoritas; rute yang belum terbit dilabeli `planned_not_published`.
...
Snapshot v0.54.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22102369](https://doi.org/10.5281/zenodo.22102369), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.54.0 menjadikan otoritas kurikulum berversi dan model-baca pelajar sebagai jembatan deterministik dari federasi backend ke situs belajar, dengan schema publik dan bukti replay; backend native setiap edisi tetap kanonik. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.54.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.54.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
