...
- Federasi v2 adalah lapisan penghubung ringkas, bukan pengganti situs atau buku: 2.479 rekaman menghubungkan 34 dataset, 40 mata kuliah, 155 permukaan baca unik, 43 rute publik, 67 peristiwa publikasi, 17 peristiwa QA, dan 2.122 identitas v1. Satu URL pembaca direpresentasikan satu kali dengan beberapa aksi (`learn`, `html`, atau `offline`) agar antarmuka pelajar dan mesin tidak menduplikasi permukaan yang sama. Seluruh sumber korpus dan backend native pemilik tetap menjadi otoritas; rute yang belum terbit dilabeli `planned_not_published`.
- Snapshot v0.60.0 memperbarui C110 ke edisi lengkap 3.0-id.2-r1 (31 unit; PDF 387 halaman) dan D40 ke checkpoint Unit 13 (PDF 193 halaman serta HTML/MathML 42 halaman). D40 tetap berstatus produksi. Checkpoint yang belum lengkap tidak dihitung sebagai korpus selesai.
...
Snapshot v0.60.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22143506](https://doi.org/10.5281/zenodo.22143506), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.60.0 menambahkan inventaris asesmen O001/A00, kontrak kapabilitas global, pembaruan C110 dan D40, serta federasi v2/v2.2 yang tervalidasi. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.60.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.60.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
