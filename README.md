...
Snapshot v0.62.2 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22164316](https://doi.org/10.5281/zenodo.22164316), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.62.2 mempertahankan persis 64 berkas pendahulunya dan menambahkan overlay pelajar B20/B50, manifest, validasi, checksum, serta paket sumber ringkas. `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_LIVE_v0.62.2.html` adalah salinan HTML mandiri; situs belajar publik tetap menjadi pintu masuk utama.
