...
- Dua puluh sembilan peran mata kuliah sudah memiliki edisi lengkap yang dapat dibaca secara publik. Peran-peran itu memakai dua puluh delapan rekaman edisi berbeda karena C30 dan C40 berbagi satu edisi Judson. A10 kini lengkap 82/82 modul dalam pembaca 2.154 halaman; B20 dan B50 lengkap bersama buku soal serta backend modularnya; C20 lengkap sebagai pembaca 241 halaman; D20 lengkap 17/17 bab; D60 lengkap pada v0.31.7; dan paket gabungan D70 lengkap dalam empat komponen. Status lengkap dan produksi tidak dicampur.
...
- Backend v2.3 kini memiliki lima bukti jalur yang diterima: A00, B10, D20, D60, dan D110. Paket konformansi v0.1.1 pada [rilis pusat v0.62.6](https://github.com/KokunoYumeto/program-matematika-indonesia/releases/tag/v0.62.6) tetap dibatasi pada A00 + O001. Adapter B10 v0.2.0 memakai kontrak generik 2.3.1 untuk memetakan 161 unit dan 284 relasi ke 1.264 rekaman tanpa menyalin prosa atau 163.583 rekaman native pemilik. Adapter D20 v0.1.0 memproyeksikan 32.383 rekaman native dan 2.104 baris indeks tambahan menjadi 138.894 rekaman kanonik, dengan 32.383 pemetaan reversibel dan 19 tabel JSONL/CSV lossless. Adapter D60 v0.1.0 pada [rilis pusat v0.62.10](https://github.com/KokunoYumeto/program-matematika-indonesia/releases/tag/v0.62.10) memvalidasi 27.642 rekaman kanonik dan mempertahankan 8.338 rekaman native pemilik. Adapter D110 v0.1.0 pada [rilis pusat v0.62.11](https://github.com/KokunoYumeto/program-matematika-indonesia/releases/tag/v0.62.11) memvalidasi 41.460 rekaman kanonik, 9.272 pemetaan native reversibel, 19 tabel JSONL/CSV lossless, dan mempertahankan 10.978 rekaman backend native pemilik. Rute belajar kelimanya tetap halaman HTML pemilik; lima bukti ini tidak mengklaim kepatuhan 35 peran lain. Rincian dan skema publik berada di [indeks backend v2.3](docs/schema/v2.3/index.html).
