...
Snapshot v0.53.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22097431](https://doi.org/10.5281/zenodo.22097431), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.53.0 menambahkan edisi D20 lengkap, pembaca HTML langsung, navigasi kelanjutan mata kuliah, migrasi backend D20, dan federasi v2 yang dibangun dari katalog rilis eksplisit. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.53.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.53.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
