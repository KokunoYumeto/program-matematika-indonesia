...
- Delapan belas peran mata kuliah sudah memiliki edisi lengkap yang dapat dibaca secara publik. Delapan belas peran itu memakai tujuh belas rekaman edisi berbeda karena C30 dan C40 berbagi satu edisi Judson. Tambahan terbaru adalah B60 Kalkulus Vektor: buku teks lengkap 316 halaman dan buku latihan lengkap 486 halaman. C100 Geometri tetap membuka kursus utama yang bersih hak melalui pembaca HTML semantik; workbook Unit 001–010 sepanjang 110 halaman berada pada lini lisensi terpisah dan tampil sebagai sumber tambahan.
...
- Federasi v2 adalah lapisan penghubung ringkas, bukan pengganti situs atau buku: 2.463 rekaman menghubungkan 34 dataset, 40 mata kuliah, 144 permukaan baca unik, 43 rute publik, 63 peristiwa publikasi, 16 peristiwa QA, dan 2.122 identitas v1. Satu URL pembaca direpresentasikan satu kali dengan beberapa aksi (`learn`, `html`, atau `offline`) agar antarmuka pelajar dan mesin tidak menduplikasi permukaan yang sama. Seluruh sumber korpus dan backend native pemilik tetap menjadi otoritas; rute yang belum terbit dilabeli `planned_not_published`.
- Checkpoint produksi publik yang diindeks pada v0.58.0 mencakup A10 (31/82 modul; 984 halaman), A30 (32/87 modul sampai `m49367`; 947 halaman), keluarga Lebl U397 (397 unit: R006 312, R007 35, R008 50; C10 lengkap 334 halaman; C20 226 halaman sampai §11.8.1; bab sistem nonlinear B70 40 halaman), D10 (338/672 halaman), dan D40 (Unit 12; 154 halaman). Status parsial tetap dinyatakan pada kartu dan tidak dihitung sebagai korpus selesai.
...
Snapshot v0.58.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22105611](https://doi.org/10.5281/zenodo.22105611), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.58.0 menambahkan CLP4 lengkap, checkpoint pemilik terbaru, sumber tambahan yang terstruktur, serta rute bersih C100/D20 yang dapat dibaca ulang. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.58.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.58.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
