...
The central site proves reciprocal navigation for every centrally hosted reader page. A separate hash-bound audit currently tracks 27 program-controlled HTML readers hosted in sibling repositories or archival endpoints: all 27 are reachable, three already expose a verified program return, and 24 remain explicit remediation work. A central card that links outward is not misreported as proof that the external reader links back.
