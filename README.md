...
- Lapisan tambahan v2.1 kini membuktikan proyeksi unit dan pencarian tanpa menyalin prosa: pilot A00 (75 unit), B10 (161 unit), dan D20 (19 akar unit, 686 relasi) semuanya lolos validasi deterministik tanpa peringatan. D20 juga memiliki indeks pelajar HTML pusat di [`/id-ID/courses/D20/`](docs/id-ID/courses/D20/index.html) yang menautkan ke 17 rute bab publik `/output/html/bab-NN/index.html`; rute pendek yang 404 tidak pernah dipancarkan.
...
Snapshot v0.56.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22103522](https://doi.org/10.5281/zenodo.22103522), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.56.0 mempertahankan kursus utama C100 Geometri sebagai edisi publik lengkap tanpa mencampurkan workbook berlisensi terpisah, lalu menambahkan pilot backend unit v2.1 dan indeks pelajar HTML D20. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.56.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.56.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
