...
- Backend v2.3 kini memiliki dua bukti jalur yang diterima. Paket konformansi v0.1.1 pada [rilis pusat v0.62.6](https://github.com/KokunoYumeto/program-matematika-indonesia/releases/tag/v0.62.6) tetap dibatasi pada A00 + O001. Adapter B10 v0.2.0 memakai kontrak generik 2.3.1 untuk memetakan 161 unit, 284 relasi, 161 dokumen pencarian metadata, status terjemahan, hak, aksesibilitas, dan namespace ke 1.264 rekaman tanpa menyalin prosa atau 163.583 rekaman native pemilik. Semua 19 tabel JSONL mempunyai CSV lossless; rute belajar tetap halaman HTML pemilik. Kedua bukti ini tidak mengklaim kepatuhan 38 peran lain. Rincian dan skema publik berada di [indeks backend v2.3](docs/schema/v2.3/index.html).
