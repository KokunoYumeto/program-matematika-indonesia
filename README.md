...
- Paket konformansi backend v2.3 v0.1.1 pada [rilis pusat v0.62.5](https://github.com/KokunoYumeto/program-matematika-indonesia/releases/tag/v0.62.5) menutup celah interoperabilitas secara aditif: semua 24 tabel JSONL diproyeksikan ke CSV per tabel dan satu `records.csv` lossless, keadaan terjemahan hanya diterbitkan bila terikat bukti, label kapabilitas lama dipetakan eksplisit, dan hubungan namespace yang belum terbukti tetap ditandai belum terselesaikan. Klaim pilot ini sengaja dibatasi pada A00 + O001; 39 peran lain belum diklaim patuh v2.3.
