...
- Lima belas peran mata kuliah sudah memiliki edisi lengkap yang dapat dibaca secara publik. Kelima belas peran itu memakai empat belas rekaman edisi berbeda karena C30 dan C40 berbagi satu edisi Judson. v0.52.0 mempertahankan jumlah itu: situs belajar tetap menjadi tujuan utama, sedangkan lembar mulai-belajar PDF menjadi pratinjau Zenodo sebelum arsip mesin.
- Backend bersama v1 tetap dibekukan: 38 tabel ketat, identitas UUIDv5, varian bahasa terpisah, rute pembelajaran, hak komponen, bukti build/QA, JSONL kanonik, dan CSV lossless. Paket pusat 2.122 rekaman telah lolos dua ekspor identik. Dua belas bukti migrasi korpus lengkap kini terikat; tambahan terbaru adalah *Tea Time Numerical Analysis* (C110), 28.172 rekaman native menjadi 53.055 rekaman umum, dan *Linear Algebra* Hefferon (B40), 22.131 rekaman native menjadi 22.131 rekaman umum, keduanya melalui adapter virtual tanpa menyalin backend besar pemilik.
- Federasi v2 adalah lapisan penghubung ringkas, bukan pengganti situs atau buku: 2.439 rekaman menghubungkan 34 dataset, 40 mata kuliah, 136 permukaan baca, 41 rute publik, bukti publikasi, dan 2.122 identitas v1. Seluruh sumber korpus dan backend native pemilik tetap menjadi otoritas; rute yang belum terbit dilabeli `planned_not_published`.
...
Snapshot v0.52.0 dipertahankan di [Zenodo, DOI 10.5281/zenodo.22088577](https://doi.org/10.5281/zenodo.22088577), dalam [lineage konsep 10.5281/zenodo.22059707](https://doi.org/10.5281/zenodo.22059707). Snapshot ini sengaja berstatus pekerjaan berjalan: 40 dari 40 peran sudah memiliki korpus terpilih atau spesifikasi asli yang dibekukan dan backend bersama dapat direproduksi, tetapi sebagian besar terjemahan, penutupan solusi, migrasi backend per-korpus, dan edisi final masih diproduksi. v0.52.0 menambahkan federasi v2 yang tervalidasi serta bukti migrasi C110 dan B40 tanpa menambah klaim penyelesaian mata kuliah. Zenodo membuka `00_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.52.0.pdf` sebagai pratinjau manusia; `01_MULAI_BELAJAR_PROGRAM_MATEMATIKA_INDONESIA_v0.52.0.html` adalah salinan HTML mandiri, dan situs belajar publik tetap menjadi pintu masuk utama.
