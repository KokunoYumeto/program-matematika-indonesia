...
export const liveCoursePublications = Object.freeze({
  A20: publication({
    ...
    version: '0.3.0-wip',
    note: 'Checkpoint publik memuat 48 dari 83 modul berurutan dalam pembaca 1.977 halaman. Kanon lokal telah mencapai 50 modul, sedangkan gabungan keluaran terjemahan tersegel mencapai 73 modul; bagian yang belum diintegrasikan bukan edisi publik.',
    progress: {
      ...
      updatedAt: '2026-08-29T02:21:36+02:00',
    },
  }),
  A30: publication({
    state: 'production',
    edition: 'https://zenodo.org/records/22150333/files/OpenStax-Precalculus-2e-id-ID-0.1.0-alpha.33-reader.pdf?download=1',
    zenodo: 'https://doi.org/10.5281/zenodo.22150333',
    repository: 'https://github.com/KokunoYumeto/openstax-precalculus-2e-id',
    version: '0.1.0-alpha.33-reader.1',
    note: 'Seluruh 87 modul memiliki terjemahan, 79 telah menjadi masukan integrasi, 38 identitas berada dalam kanon lokal, dan 33 telah diterbitkan. Satu identitas kanon masih memerlukan penyegelan ulang manifest setelah perbaikan m49384; edisi publik tetap alpha.33, 1.063 halaman.',
    progress: {
      unitLabel: 'modul OpenStax',
      totalUnits: 87,
      ...
      publicUnits: 33,
      publicPages: 1063,
      publicBoundary: '33/87 modul berurutan; sampai m49368',
      updatedAt: '2026-08-29T00:47:57+02:00',
    },
  }),
  B30: publication({
    state: 'production',
  ...
  D10: publication({
    state: 'production',
    edition: 'https://zenodo.org/records/22149439/files/00_READ_FIRST_FONDASI_TEORI_UKURAN_V1_DAN_V2_HINGGA_BAB_25.pdf?download=1',
    zenodo: 'https://doi.org/10.5281/zenodo.22149439',
    repository: 'https://github.com/KokunoYumeto/fremlin-measure-theory-id',
    version: '0.18.0',
    note: 'Edisi publik mencapai 389 dari 672 halaman sumber, melalui Bab 25 lengkap, dalam pembaca fisik 419 halaman. Kandidat lokal Bab 26 mencapai halaman sumber 444 tetapi masih menunggu penerimaan visual deterministik dan bukan kanon atau publik.',
    progress: {
      unitLabel: 'halaman sumber',
      totalUnits: 672,
      translationBearingUnits: 444,
      integrationReadyUnits: 389,
      canonicalUnits: 389,
      publicUnits: 389,
      totalPages: 672,
      publicPages: 419,
      publicBoundary: '389/672 halaman sumber; Bab 25 lengkap',
      updatedAt: '2026-08-29T00:00:00+02:00',
    },
  }),
  D20: publication({
