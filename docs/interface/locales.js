...
export const interfaceCopy = {
  id: {
    ...
    originalLanguage: 'Bahasa bahan', bindingNote: 'Sumber asli ditampilkan di samping edisi program, dalam bahasa aslinya. Tautan sumber buku tidak mencakup pendamping orisinal program. Salinan lokal belum tersedia untuk semua bahasa; tautan eksternal bukan salinan lokal. Status katalog adalah snapshot publikasi, bukan kemajuan terjemahan saat ini.',
  ...
  en: {
    ...
    originalLanguage: 'Material language', bindingNote: 'Original sources appear beside program editions, in their actual languages. Book-source links do not include program-original companions. Local mirrors are not yet available for every language; external links are not local mirrors. Catalog snapshots do not measure current translation progress.',
